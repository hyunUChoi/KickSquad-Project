...
<body>
	<div class="main">
		<div>
			...
			<img src="resources/image/out-line.png" alt="header" class="main-img2" />
		</div>
		<div class="middle">
			<div class="head">
				<h2>KickSquad</h2>
			...
			<div class="body2">
							...
							<c:choose>
								<c:when test="${mvo.grade == 'white'}">
									<div>
										...
										<span>
											(다음등급까지
											<c:set var="add" value="${100 - mvo.point}"> </c:set>
											${add}P)
										</span>
									</div>
									<div class="point-box">
								...
								<c:when test="${mvo.grade == 'gold'}">
									<div>
										<span>${mvo.grade}등급</span>
										<span>(다음등급까지<c:set var="add" value="${300 - mvo.point}"></c:set>${add}P)</span>
									</div>
									<div class="point-box">
										<span class="point1">${mvo.point}</span>
									...
									<div class="pointbar">
									<c:set var="point" value="${(mvo.point-100)/2}"> </c:set>
								...
								<c:when test="${mvo.grade == 'vip'}">
									<div>
										<span>${mvo.grade}등급</span>
										<span>(다음등급까지<c:set var="add" value="${500 - mvo.point}"></c:set>${add}P)</span>
									</div>
									<div class="point-box">
										<span class="point1">${mvo.point}</span>
									...
									<div class="pointbar">
									<c:set var="point" value="${(mvo.point -300)/2}"> </c:set>
										<div style="width:${point}%" class="bar"></div>
									</div>
								</c:when>
				...
				<div class="promotion">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img src="resources/image/일러스트1.png" alt="슬라이드1" />
				...
				<div class="modal_login">
					<table>
						<tr>
							...
							<td>
								<input class="input-text1" type="text" id="id1" name="id" placeholder="아이디를 입력해주세요." />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input class="input-text1" type="password" id="pw1" name="pw"
				...
				<div class="modal_middle">
					<table>
						<tr>
							<td><span class="material-icons">person</span></td>
							<td>
								<input id="id2" class="input-text" name="id" type="text" autocomplete="username"
									required oninput="checkId()" placeholder="아이디를 입력하세요(필수)" />
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td><span class="material-icons">lock</span></td>
							<td>
								<input id="pw2" class="input-text" name="pw" type="password"
						...
						<tr>
							...
							<td>
								<input id="name2" class="input-text" name="name" type="text"
						...
						<tr>
							...
							<td>
								<input id="tel2" class="input-text" name="tel" type="text"
